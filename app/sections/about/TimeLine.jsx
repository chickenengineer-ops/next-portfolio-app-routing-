...
const TimeLineData = [
	{ year: 2023, text: "Specialized in Next.js, building SEO-friendly React apps with server-side rendering and API integration." },
	{ year: 2022, text: "Focused on React, delivering dynamic, interactive web apps with modern UI and state management tools." },
	{ year: 2020, text: "Built scalable frontends with React and backend services using Node.js, Express, PostgreSQL, and MongoDB." },
	{ year: 2018, text: "Developed full-stack projects using PHP, JavaScript, MySQL, and explored Vue.js and Angular frameworks." },
	{ year: 2014, text: "Created and launched my first dynamic website, beginning my journey into full-stack web development." }
];
